...
for (const sample of samples) {
   ...
   sample.point = [
      ...
      features.getSymmetry(paths),          // Adding Symmetry
      features.getStrokeDirectionality(paths) // Adding Stroke Directionality
   ];
}

const featureNames = ["Path Count", "Point Count", "Symmetry", "Stroke Directionality"];
